...
1. Por que una imagen no es lo mismo que un contenedor.
  La imagen es la pura construccion de el contenedor por asi decirlo, con la imagen puedo crear el contenedor pero no tengo nada dentro o no corre asi aun.
...
3. Por que el JSON no debe guardarse dentro de recursos del `.jar`.
  El json es volumen y no debe ser parte del jar que se contruye, es como un programa de apuntes donde tiene apuntes del desarrollador metidos.
...
5. Que hace el mapeo de puertos.
  Define que contenedores usan los puertos abierto y define que camino toma
